...
const cardsSelected = document.querySelector(".grid-container-selected-cards");
...
const brandfilter=()=>{
    ...
    if(brands.value!=="Select an option"){
        ...
        var filteredCard=listOfCars.filter(car=>brands.value===Object.keys(car)[0]);
